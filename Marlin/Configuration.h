...
#define STRING_CONFIG_H_AUTHOR "(Pragma, Ender-3 Pro)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 205.33
  #define DEFAULT_bedKi  38.89
  #define DEFAULT_bedKd 722.76
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.8, -40.5, -2.73 }
